...
"${U_UTOPIA_WINDOWS_PRE_DIR}/debug/harfbuzz/include")

u_import_static_library(U_HARFBUZZ 
"${U_UTOPIA_WINDOWS_PRE_DIR}/debug/harfbuzz/lib/libharfbuzz.a")

else()

set(U_DEPENDENCE_HARFBUZZ_INCLUDE_DIR 
"${U_UTOPIA_WINDOWS_PRE_DIR}/harfbuzz/include")

u_import_static_library(U_HARFBUZZ 
"${U_UTOPIA_WINDOWS_PRE_DIR}/harfbuzz/lib/libharfbuzz.a")
